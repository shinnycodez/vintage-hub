...
function ProductCard({ title, description, imageUrl, price }) {
  return (
    <div className="flex h-full flex-1 flex-col gap-4 rounded-lg bg-[#FFF2EB] shadow-[0_0_6px_rgba(0,0,0,0.08)] min-w-[240px] md:min-w-60">
      {/* Image */}
      ...
      <div className="flex flex-col flex-1 justify-between p-4 pt-0 gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#FFE9DD] text-[#141414] text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#FFDCDC] transition"
          >
