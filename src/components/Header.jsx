...
const Header = () => {
  ...
  return (
    <>
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#ededed] bg-[#fefaf9] px-4 md:px-10 py-3 relative">
...
#fefaf9] items-center justify-center pl-4 rounded-l-lg border-r-0">
...
#fefaf9] focus:border-none h-full placeholder:text-neutral-500 px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
                value={searchQuery}
...
#fefaf9] text-[#141414] hover:bg-[#FFDCDC] transition">🛒 Cart</button>
            {user ? (
              <>
                <button onClick={handleLogout} className="px-4 h-10 rounded-lg bg-[#
#fefaf9] text-[#141414] text-sm font-semibold hover:bg-[#
#fefaf9] transition">Logout</button>
...
#fefaf9] text-white text-sm font-semibold hover:opacity-90 transition"
              >
